...
pub fn make_typescript_enum(folder: &str) -> Result<String, io::Error> {
...
fn map_file_stem_to_name(folder: &str) -> Result<Vec<TypeScriptImageUriEnum>, io::Error> {
...
fn read_file_paths_in_folder(folder: &str) -> Result<Vec<PathBuf>, io::Error> {
